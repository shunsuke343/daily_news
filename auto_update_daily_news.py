...
HTML_PATH = ROOT / "外装製品デイリーニュース.html"
...
TAG_RULES = [
    (r"外装|外観|ボディ|車体|エクステリア|exterior", "外装"),
    (r"グリル|バンパー|フェンダー|ボンネット|トランク|リアゲート", "ボディパネル"),
    (r"ヘッドライト|テールランプ|デイライト|DRL|ランプ|照明", "ランプ"),
    (r"エアロ|空力|Cd|ダウンフォース|スポイラー|ディフューザー", "空力"),
    (r"ホイール|タイヤ|リム", "足回り"),
    (r"塗装|コーティング|表面処理|耐候|防錆|防食", "表面処理"),
    (r"ミラー|サイドミラー|カメラミラー|ドアハンドル", "外装機能"),
    (r"ガラス|ウィンドウ|ワイパー|サンルーフ", "ガラス"),
    (r"センサー|LiDAR|レーダー|カメラ|ADAS", "センシング"),
    (r"EV|電動|電気自動車|充電口|バッテリー|BEV", "EV"),
    (r"安全|衝突|歩行者保護|セーフティ", "安全"),
    (r"素材|樹脂|アルミ|鋼板|CFRP|リサイクル|サステナ", "新素材"),
    (r"カスタム|エアロパーツ|ボディキット|ドレスアップ", "カスタマイズ"),
]
